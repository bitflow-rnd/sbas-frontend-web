      ...
      <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
        ...
        <div class="d-flex align-items-stretch" id="kt_app_header_menu_wrapper">
          ...
          <div class="menu menu-top-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-600 menu-state-dark menu-arrow-gray-400 fw-semibold fw-semibold fs-6 align-items-stretch my-5 my-lg-0 px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
            ...
            <!--end:Menu item-->
            <!--begin:Menu item-->
            <router-link to="" @click="handlefunc(getBdList,1)" :class="{'here': tabidx === 1}" class="menu-item me-0 me-lg-1">
              <!--begin:Menu link-->
              <span class="menu-link">
        ...
        <div class="app-navbar flex-shrink-0">
          ...
          <div class="app-navbar-item" id="kt_header_user_menu_toggle">
            ...
            <div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
              <img class="symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" src="/img/avatars/ic-user-default.svg" alt="user" />
            </div>
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
              ...
              <div class="menu-item px-5">
                <a href="" data-bs-toggle="modal" data-bs-target="#kt_modal_user_profile_view" class="menu-link px-5">내 정보</a>
              </div>
              <!--end::Menu item-->
              <!--begin::Menu item-->
              <div class="menu-item px-5">
