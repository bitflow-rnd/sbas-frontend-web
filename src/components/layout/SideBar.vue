  ...
  <section class="app-lnb">
    <div class="lnb-wrap">
      <div class="depth-group">
        ...
        <div class="depth-body-box">
          <ul class="depth1">
            <li class="depth1-box"><router-link to="/admin/comm/cd/cdgrp/list" @click="setActive(1)" :class="{'': tabidx === 1}" class="depth1-btn">공통코드 관리</router-link></li>
        ...
        <div class="depth-body-box">
          <ul class="depth1">
            ...
            <li class="depth1-box"><router-link to="/admin/organ/medinst/list" @click="setActive(7)" :class="{'': tabidx === 7}" class="depth1-btn active">의료기관 관리</router-link></li>
