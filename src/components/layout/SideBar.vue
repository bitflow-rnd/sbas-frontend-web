    ...
    <div class="lnb-wrap">
      <div class="depth-group">
        ...
        <div class="depth-body-box">
          <ul class="depth1">
            <li class="depth1-box"><router-link to="" @click="handlefunc(getUserList,0)" :class="{'active': tabidx === 0}" class="depth1-btn">사용자 관리</router-link></li>
          </ul>
        </div>
        <div class="depth-head-box">
        ...
        <div class="depth-body-box">
          <ul class="depth1">
            <li class="depth1-box"><router-link to="/admin/comm/cd/cdgrp/list" @click="setActive(1)" :class="{'active': tabidx === 1}" class="depth1-btn">공통코드 관리</router-link></li>
            <li class="depth1-box"><router-link to="/admin/comm/ancmt/list" @click="setActive(2)" :class="{'active': tabidx === 2}" class="depth1-btn">공지사항 관리</router-link></li>
            <li class="depth1-box"><router-link to="/admin/comm/usgterm/list" @click="setActive(3)" :class="{'active': tabidx === 3}" class="depth1-btn">약관/방침 관리</router-link></li>
            <li class="depth1-box"><router-link to="#none" @click="setActive(4)" :class="{'active': tabidx === 4}" class="depth1-btn">App 버전 관리</router-link></li>
          </ul>
        </div>
        <div class="depth-head-box">
