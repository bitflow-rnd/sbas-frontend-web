  ...
  <div class="popup-wrapper">
    <div class="popup-contents">
      <div class="popup-head-box py-5 px-10">
        <div class="head-tit-box">비밀번호 초기화</div>
        <div class="btn btn-sm btn-icon btn-active-color-primary">
          <router-link to="" @click="emit('openInitPw')" class="popup-close-btn">
                ...
                <tr>
                  ...
                  <td class="vertical-top">
                    <div class="item-cell-box full">
                      <div class="tbox full">
                        <input type="text" v-model="model.id" maxlength="15"/>
                      </div>
                    </div>
                  </td>
                </tr>
...
const emit = defineEmits(['openInitPw'])
...
function check() {
  ...
  const url = `${API_PROD}/api/v1/public/user/init-pw`
  const request = {
    id: model.id,
    userNm: model.name,
