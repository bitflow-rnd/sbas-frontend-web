      ...
      <div class='modal-content'>
        ...
        <div class='modal-body px-10 py-5'>
          ...
          <div class='row second'>
            <markdown :source='model.src' class='markdown' />
          </div>
        </div>
      </div>
    </div>
...
let model = reactive({
  src: "제1장 총칙\n" +
    ...
    "제 1 조 (목적)\n" +
    "--------------\n" +
    "### ① 본 이용약관(이하 '약관')은 스마트병상배정시스템 사이트 (이하 'SBAS')가 제공하는 모든 서비스(이하 '서비스')의 이용조건 및 절차, 이용자와 스마트병상배정시스템의 권리, 의무 및 임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.\n" +
    "### ② 이 약관은 스마트병상배정시스템(www.smartbas.org), 산업기술지원(itech.keit.re.kr), 국가균형발전종합정보시스템(www.nabis.go.kr), 실시간통합연구비관리시스템(www.rcms.go.kr), 산업기술개발장비(www.etube.re.kr), 연구지원전문가교육과정(academy.keit.re.kr), 산업기술R&amp;D종합정보시스템(www.ernd.go.kr) 홈페이지 이용 기본 약관에 적용됩니다.\n" +
    "\n" +
    "제 2 조 (약관의 효력과 변경)\n" +
    "----------------------------\n" +
    ...
    "#### (4) 개인정보의 보호 : 회원의 개인정보는 오직 회원만이 열람/수정/삭제 할 수 있으며, 이는 전적으로 회원의 이용자ID와 비밀번호에 의해 관리되고 있습니다.\n" +
    "#### 따라서 타인에게 회원의 이용자ID와 비밀번호를 알려주어서는 안되며, 작업 종료 시에는 반드시 로그아웃 하고, 웹 브라우저의 창을 닫아야 합니다.(이는 타인과 컴퓨터를 공유하는 인터넷 카페나 도서관 같은 공공장소에서 컴퓨터를 사용하는 경우에 회원의 정보보호를 위하여 필요한 사항입니다)"
})
</script>
