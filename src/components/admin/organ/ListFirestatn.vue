<template>
          ...
          <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-base">
              ...
              <li class="breadcrumb-item text-gray-500 mx-n1"><h1
                  class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-2 m-0">구급대
                관리</h1></li>
              <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
                ...
                <div class="table-body-box">
                  ...
                  <div class="table-box with-scroll small">
                    <table>
                      ...
                      <tbody>
                      <tr :class="{'selected':fsDetail.instId===item.instId}" @click="getFS(item)"
                          v-for="(item,i) in firestatnList" :key="i">
                        <td>{{ i + 1 }}</td>
                        <td>
                        ...
                        <td>
                          <a @click="handleModal(5,item)"
                             class="btn btn-flex btn-xs btn-outline btn-outline-primary">수정</a>

                          <a @click="handleModal(1,item)"
                             class="btn btn-flex btn-xs btn-outline btn-outline-primary ms-2">상세</a>
                        </td>
                      </tr>
                      </tbody>
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                  <div class="dataTables_paginate paging_simple_numbers" id="kt_table_users_paginate">
                    <ul class="pagination">
                      ...
                      <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="2"
                                                                tabindex="0" class="page-link">2</a>
                      </li>
                      <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="3"
          ...
          <article class="card-sub-contents px-6" style="width: 560px;">
            ...
            <div class="card-option p-8">
              <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end">
                ...
                <a @click="delFM" class="btn btn-flex btn-sm btn-outline btn-outline-light fs-7"><i
            ...
            <div class="card-sub-wrap p-8">
              ...
              <div class="card-body p-0">
                <!--begin::Table-->
                <h5 v-if="firemenList.length!==0">조회결과<span
                    class="position-absolute translate-middle rounded-pill bg-primary">{{ firemenList.count }}</span>
                </h5>
                <h5 v-if="firemenList.length===0">조회결과<span
                    class="position-absolute translate-middle rounded-pill bg-primary">0</span></h5>
                ...
                <div class="row mt-10">
                  ...
                  <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="dataTables_paginate paging_simple_numbers" id="">
                      <ul class="pagination">
                        <li class="paginate_button page-item previous disabled" id=""><a href="#"
                                                                                         aria-controls="kt_table_users"
                        ...
                        <li class="paginate_button page-item next" id=""><a href="#" aria-controls="kt_table_users"
                    ...
                    <td colspan="3">
                      ...
                      <div class="item-cell-box full">
                        ...
                        <div class="textbox full">
                          <textarea v-model="fsForm.rmk" maxlength="500" placeholder="메시지 입력"
  ...
  <!-- 구급대 수정   -->
  <div v-if="fsDetail!==null" v-show="openModal[5]" class="modal fade" id="kt_modal_group_edit" tabindex="-1"
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                      ...
                      <div class="item-cell-box full">
                        ...
                        <div class="textbox full">
                          <textarea v-model="fsDetail.rmk" @input="updateCharacterCount" maxlength="500"
                                    placeholder="메시지 입력" style="height: 120px;"></textarea>
  ...
  <!-- 구급대 상세   -->
  <div v-if="fsDetail!==null" v-show="openModal[1]" class="modal fade" id="kt_modal_group_view" tabindex="-1"
       aria-hidden="true" style="">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1500px modal-dialog-centered">
      <!--begin::Modal content-->
  ...
  <!-- 구급대원 등록   -->
  <div v-if="fsDetail!==null" v-show="openModal[2]" class="modal fade" id="kt_modal_member_edit" tabindex="-1"
       aria-hidden="true" style="">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1500px modal-dialog-centered">
      <!--begin::Modal content-->
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y py-10 px-10">
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                      ...
                      <div class="item-cell-box full">
                        ...
                        <div class="textbox full">
                          <textarea v-model="fmForm.rmk" maxlength="500" placeholder="메시지 입력"
                                    style="height: 120px;"></textarea>
          ...
          <article class="modal-menu-layout1 pt-10">
            <div class="modal-menu-list">
              <router-link to="" @click="onSubmitFM(fsDetail.instId)" class="modal-menu-btn menu-primary">저장
              </router-link>
            </div>
          </article>
  ...
  <!-- 구급대원 수정 -->
  <div v-if="fmDetail!==null && fsDetail!==null" v-show="openModal[3]" class="modal fade" id="kt_modal_member_edit"
                  ...
                  <tr>
                    ...
                    <td colspan="3">
                      ...
                      <div class="item-cell-box full">
                        ...
                        <div class="textbox full">
                          <textarea v-model="fmDetail.rmk" @input="updateCharacterCount" maxlength="500"
                                    placeholder="메시지 입력" style="height: 120px;"></textarea>
  ...
  <!-- 구급대원 상세   -->
  <div v-if="fmDetail!==null && fsDetail!==null" v-show="openModal[4]" class="modal fade" id="kt_modal_member_view"
       tabindex="-1" aria-hidden="true" style="">
    <!--begin::Modal dialog-->
    <div class="modal-dialog mw-1500px modal-dialog-centered">
      <!--begin::Modal content-->
      ...
      <div class="popup-contents py-10 px-10" style="width: 300px;">
        ...
        <article class="modal-menu-layout1">
          <div class="modal-menu-list">
            ...
            <router-link to="" @click="alertClose" class="modal-menu-btn menu-primary" data-type=success>확인
            </router-link>
          </div>
        </article>
      </div>
