                ...
                <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center gap-1 me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-base">
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-gray-500 mx-n1"><h1 class="page-heading d-flex flex-column justify-content-center text-dark fw-bolder fs-2 m-0">구급대 관리</h1></li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                        <!--begin::Title-->
                    ...
                    <div class="card-contents" style="flex:1; min-width:0;">
                        ...
                        <div class="card-option p-8 pb-0">
                            <div class="d-flex align-items-center gap-2 gap-lg-3 justify-content-end">
                                ...
                                <a @click="handleModal(0,null)" class="btn btn-sm btn-flex btn-primary align-self-center px-3">
                                                ...
                                                <td>
                                                    <div class="item-cell-box">
                                                        ...
                                                        <div class="tbox full with-btn ms-2" style="max-width:300px;">
                                                            <input v-model="inputValue" @input="handleChange" type="text" placeholder="구급대명 또는 ID 입력">
                        ...
                        <div class="card-body p-8">
                            <!--begin::Table-->
                            <h5>조회결과<span class="position-absolute translate-middle rounded-pill bg-primary">{{ firestatnList.length }}</span></h5>
                                    ...
                                    <div class="table-box with-scroll small">
                                        <table>
                                            ...
                                            <tr :class="{'selected':fsDetail.instId===item.instId}" @click="getFS(item)" v-for="(item,i) in firestatnList" :key="i">
                                                ...
                                                <td>
                                                    <a @click="handleModal(5,item)" class="btn btn-flex btn-xs btn-outline btn-outline-primary">수정</a>

                                                    <a @click="handleModal(1,item)" class="btn btn-flex btn-xs btn-outline btn-outline-primary ms-2">상세</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                ...
                                <div class="col-12 d-flex align-items-center justify-content-center">
                                    <div class="dataTables_paginate paging_simple_numbers" id="kt_table_users_paginate">
                                        <ul class="pagination">
                                            ...
                                            <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="2" tabindex="0" class="page-link">2</a>
                                            </li>
                                            <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="3" tabindex="0" class="page-link">3</a>
                                            </li>
...
<!--                                <a @click="delFM" href="#" class="btn btn-flex btn-sm btn-outline btn-outline-light fs-7" data-bs-toggle="modal" data-bs-target="#kt_modal_view_users"><i class="fa-regular fa-trash-can"></i> 삭제</a>-->
                                        ...
                                        <div class="table-box with-scroll small">
                                            <table>
                                                ...
                                                <tr v-for="(person,i) in firemenList.items" :key="i">
                                                    ...
                                                    <td>
                                                        <a @click="handleModal(3,person)" class="btn btn-flex btn-xs btn-outline btn-outline-primary">수정</a>
                                                    </td>
                                                </tr>
                                ...
                                <div class="row mt-10">
                                    ...
                                    <div class="col-12 d-flex align-items-center justify-content-center">
                                        <div class="dataTables_paginate paging_simple_numbers" id="">
                                            <ul class="pagination">
                                                <li class="paginate_button page-item previous disabled" id=""><a href="#" aria-controls="kt_table_users" data-dt-idx="0" tabindex="0" class="page-link"><i class="previous"></i></a></li>
                                                <li class="paginate_button page-item active"><a href="#" aria-controls="kt_table_users" data-dt-idx="1" tabindex="0" class="page-link">1</a></li>
                                                <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="2" tabindex="0" class="page-link">2</a>
                                                </li>
                                                <li class="paginate_button page-item "><a href="#" aria-controls="kt_table_users" data-dt-idx="3" tabindex="0" class="page-link">3</a>
                                                </li>
                                                <li class="paginate_button page-item next" id=""><a href="#" aria-controls="kt_table_users" data-dt-idx="4" tabindex="0" class="page-link"><i class="next"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
  ...
  <!--begin::Modals-->
                ...
                <div class="modal-body scroll-y py-10 px-10">
                                ...
                                <table>
                                        ...
                                        <td colspan="3">
                                            <div class="item-cell-box">
                                                ...
                                                <div class="tbox w-450px ms-3">
                                                    <input v-model="fsForm.detlAddr" placeholder="상세주소 입력 (선택사항)">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="item-cell-box full">
                                                <div class="tbox w-175px full">
                                                    <input v-model="fsForm.chrgTelno" placeholder="담당자 연락처 입력 (선택사항)">
                                                </div>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="item-cell-box full">
                                                ...
                                                <div class="textbox full">
                                                    <textarea v-model="fsForm.rmk" maxlength="500" placeholder="메시지 입력" style="height: 120px;"></textarea>
                                                    <div class="limit-box"><span id="textarea4">{{ fsForm.rmk.length }}</span>/500자</div>
                                                </div>
                    ...
                    <article class="modal-menu-layout1 pt-10">
                        <div class="modal-menu-list">
                            <router-link to="" @click="onSubmitFS" class="modal-menu-btn menu-primary">저장</router-link>
                        </div>
                    </article>
    ...
    <!-- 구급대 수정   -->
    <div v-if="fsDetail!==null" v-show="openModal[5]" class="modal fade" id="kt_modal_group_edit" tabindex="-1" aria-hidden="true" style="">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-1500px modal-dialog-centered">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y py-10 px-10">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <div class="item-cell-box">
                                                ...
                                                <div class="tbox w-450px ms-3">
                                                    <input v-model="fsDetail.detlAddr" placeholder="상세주소 입력 (선택사항)">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="item-cell-box full">
                                                <div class="tbox w-175px full">
                                                    <input v-model="fsDetail.chrgTelno" placeholder="담당자 연락처 입력 (선택사항)">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="item-cell-box full">
                                                ...
                                                <div class="textbox full">
                                                    <textarea v-model="fsDetail.rmk" @input="updateCharacterCount" maxlength="500" placeholder="메시지 입력" style="height: 120px;"></textarea>
                                                    <div class="limit-box"><span id="textarea4">{{characterCount}}</span>/500자</div>
                                                </div>
                    ...
                    <article class="modal-menu-layout1 pt-10">
                        <div class="modal-menu-list">
                            <router-link to="" @click="onEditFS" class="modal-menu-btn menu-primary">저장</router-link>
                        </div>
                    </article>
    ...
    <!-- 구급대 상세   -->
    <div v-if="fsDetail!==null" v-show="openModal[1]" class="modal fade" id="kt_modal_group_view" tabindex="-1" aria-hidden="true" style="">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-1500px modal-dialog-centered">
            <!--begin::Modal content-->
            <div class="modal-content">
                        ...
                        <div class="form-body-box">
                            ...
                            <div class="table-box">
                                <table>
                                    ...
                                    <tr>
                                        <th>주소</th>
                                        <td colspan="3">{{ fsDetail.dstrCd1+' '+fsDetail.dstrCd2+' '+fsDetail.detlAddr }}</td>
                                    </tr>
                                    <tr>
                                        <th>담당자명</th>
                                    ...
                                    <tr>
                                        <th>비고</th>
                                        <td colspan="3" style="height: 200px; vertical-align: top;">{{ fsDetail.rmk }}</td>
                                    </tr>
    ...
    <!-- 구급대원 등록   -->
    <div v-if="fsDetail!==null" v-show="openModal[2]" class="modal fade" id="kt_modal_member_edit" tabindex="-1" aria-hidden="true" style="">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-1500px modal-dialog-centered">
            <!--begin::Modal content-->
            <div class="modal-content">
                        ...
                        <form @submit="onSubmitFM" class="form-body-box">
                            ...
                            <div class="table-box">
                                <table>
                                    ...
                                    <tr>
                                        <th>구급대 주소</th>
                                        <td>{{ fsDetail.dstrCd1+' '+fsDetail.dstrCd2+' '+fsDetail.detlAddr }}</td>
                                        <th>구급대명</th>
                                        <td>{{ fsDetail.instNm }}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="item-cell-box full">
                                                ...
                                                <div class="textbox full">
                                                    <textarea v-model="fmForm.rmk"  maxlength="500" placeholder="메시지 입력" style="height: 120px;"></textarea>
                                                    <div class="limit-box"><span id="textarea5">{{fmForm.rmk.length}}</span>/500자</div>
                                                </div>
    ...
    <!-- 구급대원 수정 -->
    <div v-if="fmDetail!==null && fsDetail!==null" v-show="openModal[3]" class="modal fade" id="kt_modal_member_edit" tabindex="-1" aria-hidden="true" style="">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-1500px modal-dialog-centered">
            <!--begin::Modal content-->
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y py-10 px-10">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            ...
                                            <div class="item-cell-box full">
                                                ...
                                                <div class="textbox full">
                                                    <textarea v-model="fmDetail.rmk" @input="updateCharacterCount" maxlength="500" placeholder="메시지 입력" style="height: 120px;"></textarea>
                                                    <div class="limit-box"><span id="textarea5">{{fmDetail.rmk.length}}</span>/500자</div>
                                                </div>
                    ...
                    <article class="modal-menu-layout1 pt-10">
                        <div class="modal-menu-list">
                            <router-link to="" @click="onEditFM" class="modal-menu-btn menu-primary">저장</router-link>
                        </div>
                    </article>
    ...
    <!-- 구급대원 상세   -->
    <div v-if="fmDetail!==null && fsDetail!==null" v-show="openModal[4]" class="modal fade" id="kt_modal_member_view" tabindex="-1" aria-hidden="true" style="">
        <!--begin::Modal dialog-->
        <div class="modal-dialog mw-1500px modal-dialog-centered">
            <!--begin::Modal content-->
            <div class="modal-content">
                        ...
                        <div class="form-body-box">
                            ...
                            <div class="table-box">
                                <table>
                                    ...
                                    <tr>
                                        <th>비고</th>
                                        <td colspan="3" style="height: 200px; vertical-align: top;">{{fmDetail.rmk}}</td>
                                    </tr>
...
export default {
    ...
    computed:{
        ...mapState('admin',['cmSido','cmGugun','firestatnList','firemenList','fsDetail','fmDetail'])
    },
    setup(){
    ...
    methods: {
        ...
        handleModal(idx,data){
            if(idx===0){
                ...
                this.$store.dispatch('admin/getFiremen',request)
                this.toggleModal(idx)
            }else if(idx===2) /*구급대원등록*/{
                console.log('대원등록')
                this.toggleModal(idx)
            }else if(idx===3) /*대원수정*/{
                const request = {id:data.instId,crewId:data.crewId}
