                                ...
                                <li class="swiper-slide">
                                    <div class="item-box">
                                      ...
                                      <div class="con-box">의료 전문 IT업체와의 협업으로<br/>
                                        ...
                                        E-GEN, 병원EMR 시스템과 연계 및 확장을 도모하고 있습니다.</div>
...
div.fullpage { height: 100%; }
body, .app-root { background-color: white; }
section.main { position: relative; height: 100%; }
.inner { max-width: 1440px; margin-left: calc(50% - 720px); }
...
.section.footer { position: fixed; bottom: 0; z-index: 11; left: 0; width: 100%; }
.floating-img-box .up {
    display: block !important;
}
@media (max-width: 1024px) {
  .inner { margin-left: inherit; }
  footer { bottom: 20px; }
  footer .footer-menu-box .footer-menu-list .footer-menu-btn { width: 160px; }
  .footer-menu-btn + .footer-menu-btn { margin-left: 20px !important; }
