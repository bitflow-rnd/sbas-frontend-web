<template>
  <!--  환자 상세 정보  -->
  <div class="modal show" tabindex="-1" id="modal-patient-detail">
    <!--begin::Modal dialog-->
  ...
  <svrt-info-modal v-if='model.showSvrtInfoModal' :exist-pt='model.ptDetail' @closeModal='closeSvrtInfoModal()' />
