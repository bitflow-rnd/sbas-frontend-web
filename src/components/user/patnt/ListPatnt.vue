      ...
      <div v-if="ptList!==null" id="kt_app_content" class="app-content flex-column-fluid">
        <div class="card">
          ...
          <div class="card-body p-8">
            <!--begin::Table-->
            <h5>검색결과<span class="position-absolute translate-middle rounded-pill bg-primary">{{ ptList.count }}</span></h5>
              ...
              <div class="table-body-box">
                ...
                <div class="table-box with-scroll small">
                  <table>
                    ...
                    <tbody>
                    <tr v-for="(pt, idx) in ptList.items" :key="idx" @click="selectPatient(pt)" data-bs-target="#kt_modal_patnt_detail" data-bs-toggle="modal">
                      <td>{{ idx+ 1 }}</td>
                      <td>
                          ...
                          <article class="modal-profile-layout1">
                            ...
                            <div class="profile-card-box flex-column mx-auto" style="width: 264px;">
                              <div class="profile-view-box " style="width: 100%; height: 264px;">
                                  <img v-if="preRpt===null || preRpt === undefined" src="/img/common/img_upload_img.svg" alt="이미지">
                    ...
                    <form @submit="regNewPt" class="table-box">
                        <table>
                            ...
                            <tr>
                                    ...
                                    <div class="item-row-box">
                                        <div class="item-cell-box">
                                            ...
                                            <div class="tbox w-30px" style="min-width: 30px;">
                                                <input type="password" v-model="newPt.rrno2" class="p-0 text-center fs-3x" maxlength="1"></div>
                                ...
                                <th>나이 (만)</th>
                                <td v-if="newPt.rrno1!==undefined && newPt.rrno2!==undefined">{{getAge(newPt.rrno1,newPt.rrno2)}}</td>
                            </tr>
                                ...
                                <td>
                                    ...
                                    <div class="item-row-box">
                                        <div class="tbox" style="width: 211px;">
                                            <input type="text" placeholder="국가명 입력" v-model="newPt.natiNm" :readonly="newPt.natiCd!=='NATI0002'" class="nation-input">
                                        </div>
                                    </div>
                                </td>
    ...
    <div class="modal-dialog mw-1500px modal-dialog-centered">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y py-10 px-10">
          ...
          <article v-if="ptDetail!==null && ptDs!==null" class="detail-layout1">
                ...
                <div class="detail-foot-box">
                  <article class="modal-menu-layout1 py-10">
                    ...
                    <div class="modal-menu-list">
                      <router-link to="" data-bs-target="#kt_modal_patnt" data-bs-toggle="modal" class="modal-menu-btn menu-primary">수정</router-link>
                    </div>
                          ...
                          <tr>
                            ...
                            <td class="py-5 px-3">
                              <div class="top-info-box d-flex align-items-center">
                                ...
                                <div class="d-inline-flex align-items-center justify-content-center w-auto bg-primary h-25px w-65px text-white rounded-2 px-0 w-auto">
                                  병상요청
                                </div>
                                <div class="d-inline-flex align-items-center justify-content-center w-auto bg-gray-500 h-25px w-65px text-white rounded-2 px-0 w-auto">
                                    완료
                                </div>
...
<!--                          <tr>
                ...
                <div class="detail-foot-box">
                  <article class="modal-menu-layout1 py-10">
                    ...
                    <div class="modal-menu-list">
                      <router-link to="" data-bs-target="#kt_modal_request" data-bs-toggle="modal"  class="modal-menu-btn menu-primary">병상요청</router-link>
                    </div>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="4">
                                                    ...
                                                    <div class="item-cell-box pt-2" style="font-size:12px; letter-spacing: -0.05em; color:#696971;">
                                                        * 요청 병상 유형을 선택해주세요
                                                    </div>
                                                </td>
                                            </tr>
                                ...
                                <div class="form-body-box">
                                    ...
                                    <form @submit="regStrtPoint" class="table-box">
                                        <table>
                                            ...
                                            <tbody>
                                            <tr>
                                                <th :rowspan="spInfo.dprtDstrTypeCd==='DPTP0002'?2:1">배정요청 지역 <span class="text-primary">*</span></th>
                                                ...
                                                <td v-show="spInfo.dprtDstrTypeCd!=='DPTP0002'" style=";">
                                                    <div class="item-cell-box full">
                                                        <div class="tbox full">
                                                            <input type="text" placeholder="보호자1 연락처 입력" @input="validateInput" v-model="spInfo.nok1Telno">
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <th :rowspan="spInfo.dprtDstrTypeCd==='DPTP0002'?2:1" data-type="dynamic">환자 출발지<span class="text-primary">*</span></th>
                                                <td :rowspan="spInfo.dprtDstrTypeCd==='DPTP0002'?2:1" data-type="dynamic" style="vertical-align: top;">
                                                    <div class="item-cell-box full justify-content-between">
                                                        <article class="toggle-list-layout2">
                                                ...
                                                <td v-show="spInfo.dprtDstrTypeCd!=='DPTP0002'">
                                                    <div class="item-cell-box full">
                                                        <div class="tbox full">
                                                            <input type="text" placeholder="보호자 2 연락처 입력" @input="validateInput" v-model="spInfo.nok2Telno">
                                                        </div>
                                                    </div>
                                                </td>
                                                <!-- 출발지 병원 -->
                                            ...
                                            <tr v-if="spInfo.dprtDstrTypeCd==='DPTP0002'" >
                                                ...
                                                <td>
                                                    <div class="item-cell-box full">
                                                        <div class="tbox full">
                                                            <input type="text" placeholder="연락 전화번호 입력" @input="validateInput" v-model="spInfo.chrgTelno">
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <div class="popup-wrapper">
            <div class="popup-contents py-10 px-10" style="width: 300px;">
                ...
                <article class="modal-menu-layout1">
                    <div class="modal-menu-list">
                        <router-link to="" @click="cfrmAl(alertIdx)" class="modal-menu-btn menu-primary" data-type=success>확인</router-link>
                        <router-link v-show="cncBtn" to="" @click="alertClose" class="modal-menu-btn menu-cancel" data-type=cancel>취소</router-link>
                    </div>
                </article>
            </div>
        </div>
 ...
 /* async created() {
  ...
  methods: {
    ...
    async selectPatient(patient) {
        console.log(patient)
        if(patient.bedStatCd!=='BAST0001'){
            this.$store.dispatch('bedasgn/getTimeline',patient);
        } else{
