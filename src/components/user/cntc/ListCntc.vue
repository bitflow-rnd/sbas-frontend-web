      ...
      <div id="kt_app_content" class="app-content flex-column-fluid">
        <div class="card overflow-hidden">
          ...
          <section class="cntc-dashboard">
            ...
            <!-- contact detail -->
            <no-contact-detail-unit v-if="!user"/>
            <contact-detail-unit v-if="user"/>
            <!-- contact detail -->

            <!-- contact detail right -->
            <no-contact-detail-right-unit v-if="!user"/>
            <contact-detail-right-unit v-if="user"/>
            <!-- contact detail right -->
...
export default {
  components: {ContactDetailRightUnit, NoContactDetailRightUnit, ContactDetailUnit, NoContactDetailUnit},
  name: 'ListCntc',
  props: {
    msg: String
  },
