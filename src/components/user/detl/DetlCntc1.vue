                      ...
                      <div class="item-box">
                        ...
                        <div class="item-option-box">
                          <article class="state-label-item">
                            <a
                              href="javascript:popupOpen('state')"
                              class="state-label-box bg-danger text-white"
                              >승인/반려</a
                            >
                          </article>
                        </div>
                      ...
                      <div class="list-body-box">
                        <div class="current-item-list">
                          ...
                          <div class="current-item-box">
                            ...
                            <div class="current-con-box">
                              <span class="text-primary">133</span> 건
                            </div>
                          </div>
                          ...
                          <div class="current-item-box">
                            ...
                            <div class="current-con-box">
                              <span class="text-danger">133</span> 건
                            </div>
                          </div>
                        </div>
                      </div>
          ...
          <article class="modal-profile-layout1">
            <div class="profile-card-box">
              <div class="profile-edit-box">
                ...
                <a href="javascript:profileImgRemove()" class="remove-btn"
                      ...
                      <tr>
                        ...
                        <td>
                          <article class="check-list-layout1">
                            <div class="list-box">
                              <div
                                class="item-box d-inline-flex flex-center justify-content-center"
                              >
                                <label>
                                  <input type="checkbox" />
                ...
                <div class="table-foot-box mt-10">
                  <article class="modal-menu-layout1">
                    <div class="modal-menu-list">
                      <a href="#none" class="modal-menu-btn menu-cancel" data-bs-dismiss="modal"
                        >취소</a
                      >
                        ...
                        <div class="item-cell-box full">
                          ...
                          <div class="rbox ms-4">
                            <label>
                              ...
                              <span class="txt text-black">다른기관</span>
                            </label>
                          </div>
                        </div>
                      </div>
