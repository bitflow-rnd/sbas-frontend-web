                ...
                <div class="chat-list-wrap">
                  <a href="javascript:void(0)" class="item-box">
                    <div class="item-info-box">
                      ...
                      <div class="info-box">
                        <div class="subject-box fw-bold">
                          우상욱 팀장 <span class="new bg-primary">N</span>
                        </div>
                  ...
                  <a href="javascript:void(0)" class="item-box">
                    <div class="item-info-box">
                      ...
                      <div class="info-box">
                        <div class="subject-box fw-bold">
                          파티마병원 응급 <span class="new bg-primary">N</span>
                        </div>
                      ...
                      <div class="message-contents">
                        ...
                        <div class="msg-box">
                          <div class="msg-txt-box">
                            https://www.e-gen.or.kr/egen/holiday_medical.do?searchType=general&lat=37.5100703&lon=126.8788276
                          </div>
                          ...
                          <div class="msg-txt-box">
                            <article class="msg-file">
                              <div class="upload-file-box">
                                ...
                                <div class="txt-box text-primary">
                                  업로드 중 입니다. (gif파일 요청)
                                </div>
                              </div>
                            </article>
                ...
                <div class="chat-send-group">
                  ...
                  <div class="send-option-box">
                    ...
                    <div class="option-box">
                      <a
                        href="#none"
                        class="btn btn-flex bg-primary text-white"
                        data-bs-toggle="modal"
                        data-bs-target="#kt_modal_user_invite"
                        >전송</a
                      >
